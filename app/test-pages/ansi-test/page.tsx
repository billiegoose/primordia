...
const SAMPLES: { label: string; text: string }[] = [
  {
    ...
    text: [
      ...
      `${B}${R}✗ Install failed${RST} at step: pnpm run build (line 42, exit 1)\n`,
    ].join(""),
  },
  {
    label: "Spinner → done",
    text: [
      `${G}✓${RST} Using git 2.43.0\n`,
      `${G}✓${RST} Using bun 1.2.0\n`,
      spinThenDone("sfw pnpm install"),
      spinThenDone("pnpm run build"),
  ...
  },
  {
    ...
    text: [
      `${G}✓${RST} Using git 2.43.0\n`,
      spinThenDone("sfw pnpm install"),
      `\\ pnpm run build\r| pnpm run build\r`,
      `\r${ESC}K\n`,
      `${DIM}  --- build output ---${RST}\n`,
      `${DIM}  src/app/page.tsx:12:3 - error TS2345: Argument of type 'string'${RST}\n`,
      `${DIM}  --------------------------${RST}\n`,
      `\n${R}✗ Install failed${RST} at step: ${B}pnpm run build${RST} (line 99, exit 1)\n`,
      `\n`,
