...
function GatewaySourceCard() {
  return (
    <div id="onborda-gateway-card" className="border border-gray-700 rounded-xl overflow-hidden bg-gray-900/30 transition-colors">
...
export default function BillingSourcesSettingsClient({
  ...
  return (
    <section className="space-y-6">
      <div id="onborda-billing-sources">
