...
//
// Because the keypair is ephemeral, clients must fetch the public key when
// preparing each credential submission so an already-open tab survives a
// blue/green deploy or server restart without a page reload.
