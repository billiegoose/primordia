...
- **FloatingEvolveDialog** (the "Propose a change" popup dialog): The form inside the floating dialog now also accepts drag-and-drop of any files and paste events for images. The form border highlights amber on drag hover, consistent with the other forms.
